...
import com.github.mbto.funnyranks.broker.SessionsSender;
        ...
        if (storageFetchMode == DONT_CREATE) {
            ...
            if (storageByName == null) {
                ...
                if(log.isDebugEnabled()) {
                    log.debug(portValue + " Created storageByName registry");
                }
            }
            ...
            if (oldStorageByName != null) {
                if(log.isDebugEnabled()) {
                    log.debug(portValue + " Recreated storageByName registry");
                }
            }

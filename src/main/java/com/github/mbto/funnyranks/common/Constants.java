...
//    Pattern STEAMID2_PATTERN = Pattern.compile("^STEAM_[0-5]:([01]):(0|[1-9][0-9]{0,9})$");
    Pattern STEAMID2_PATTERN = Pattern.compile("^STEAM_0:([01]):(0|[1-9][0-9]{0,9})$");
//    Pattern STEAMID3_PATTERN = Pattern.compile("^\\[U:([0-1]):([0-9])+\\]+$");
    ...
    Pattern BCRYPT_PATTERN = Pattern.compile("^\\$2[aby]?\\$([0-3][0-9])\\$[./0-9A-Za-z]{53}$");

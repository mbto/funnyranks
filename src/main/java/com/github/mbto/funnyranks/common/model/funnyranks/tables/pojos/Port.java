...
public class Port implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        else if (!this.gameAppId.equals(other.gameAppId))
            return false;
        if (this.value == null) {
            if (other.value != null)
                return false;
        ...
        else if (!this.ffa.equals(other.ffa))
            return false;
        if (this.ignoreBots == null) {
            if (other.ignoreBots != null)
                return false;
        }
        else if (!this.ignoreBots.equals(other.ignoreBots))
            return false;
        if (this.startSessionOnAction == null) {
            if (other.startSessionOnAction != null)
                return false;
        }
        else if (!this.startSessionOnAction.equals(other.startSessionOnAction))
            return false;
        return true;
    }

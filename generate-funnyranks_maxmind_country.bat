...
"C:\GeoLite2\maxmind-geoip2-csv2sql-converter1.1\bin\maxmind-geoip2-csv2sql-converter.bat" -od "C:\GeoLite2\maxmind-geoip2-csv2sql-converter1.1\funnyranks" -oa "country_en_ru.zip" -k M8jFjv3vZWrOCaZN -c "C:\Users\%USERNAME%\IdeaProjects\funnyranks\GeoLite2-Country-CSV.mysql.funnyranks.ini" -i 4 -l "en,ru" -dc true -ds true